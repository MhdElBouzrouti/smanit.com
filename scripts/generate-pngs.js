...
async function generate() {
  ...
  // 2. YouTube Banner Image (2048x1152)
  ...
  const watermarkSvg = fs.readFileSync(path.join(BRAND_DIR, 'smanit-watermark-150.svg'));
  await sharp(watermarkSvg)
    .resize(150, 150)
    .png({ quality: 100 })
    .toFile(path.join(BRAND_DIR, 'smanit-youtube-watermark.png'));
  console.log('✓ smanit-youtube-watermark.png (150x150)');
